...
public class DtlsBugFindingTest {
    public static final String DTLS_SERVER_MODEL = "/models/dtls/MbedTLS.dot";
    public static final String DTLS_BUG_PATTERNS = "/patterns/dtls/";

    @Test
    public void testClient() throws FileNotFoundException, IOException {

        StateMachineBugFinderToolConfig config = new StateMachineBugFinderToolConfig();
        config.setModel(DTLS_SERVER_MODEL);
        config.setPatterns(DTLS_BUG_PATTERNS);
