...
public class SshCommandsExecIT extends CommandsExec {
  ...
  public void testBitViseServers () throws IOException, FormatException, InterruptedException {
    ...
    expectedOutput.addBug(new OutputBug("Unignored Authentication Request After UA_SUCCESS", "MEDIUM", "KEXINIT/KEXINIT KEX30/KEX31+NEWKEYS NEWKEYS/NO_RESP SR_AUTH/SR_ACCEPT UA_PK_OK/UA_SUCCESS UA_PK_OK/UNIMPL", "KEXINIT KEX30 NEWKEYS SR_AUTH UA_PK_OK UA_PK_OK"));
    expectedOutput.addBug(new OutputBug("Missing NEWKEYS", "MEDIUM", "KEXINIT/KEXINIT KEX30/KEX31+NEWKEYS NEWKEYS/NO_RESP SR_AUTH/SR_ACCEPT KEXINIT/KEXINIT KEX30/KEX31+NEWKEYS UA_PK_OK/UA_SUCCESS", "KEXINIT KEX30 NEWKEYS SR_AUTH KEXINIT KEX30 UA_PK_OK"));
    expectedOutput.addBug(new OutputBug("Unresponsive State", "LOW", "KEXINIT/KEXINIT NEWKEYS/NO_RESP KEXINIT/NO_RESP SR_CONN/NO_RESP KEXINIT/NO_RESP SR_CONN/NO_RESP", "KEXINIT NEWKEYS KEXINIT SR_CONN KEXINIT SR_CONN"));
    expectedOutput.addBug(new OutputBug("Transport Layer Bug", "UNKNOWN", "KEXINIT/KEXINIT KEX30/KEX31+NEWKEYS NEWKEYS/NO_RESP UA_PK_OK/NO_RESP SR_AUTH/SR_ACCEPT", "KEXINIT KEX30 NEWKEYS UA_PK_OK SR_AUTH"));
    expectedOutput.addBug(new OutputBug("Transport Layer Bug", "UNKNOWN", "KEXINIT/KEXINIT KEX30/KEX31+NEWKEYS NEWKEYS/NO_RESP UA_PK_NOK/NO_RESP SR_AUTH/SR_ACCEPT", "KEXINIT KEX30 NEWKEYS UA_PK_NOK SR_AUTH"));
    expectedOutput.addBug(new OutputBug("Transport Layer Bug", "UNKNOWN", "KEXINIT/KEXINIT KEX30/KEX31+NEWKEYS KEX30/NO_RESP NEWKEYS/NO_RESP SR_AUTH/SR_ACCEPT", "KEXINIT KEX30 KEX30 NEWKEYS SR_AUTH"));
    expectedOutput.addBug(new OutputBug("Transport Layer Bug", "UNKNOWN", "KEXINIT/KEXINIT KEX30/KEX31+NEWKEYS NEWKEYS/NO_RESP CH_OPEN/NO_RESP SR_AUTH/SR_ACCEPT", "KEXINIT KEX30 NEWKEYS CH_OPEN SR_AUTH"));
    expectedOutput.addBug(new OutputBug("Transport Layer Bug", "UNKNOWN", "KEXINIT/KEXINIT KEX30/KEX31+NEWKEYS NEWKEYS/NO_RESP CH_OPEN/NO_RESP CH_CLOSE/NO_RESP SR_AUTH/SR_ACCEPT", "KEXINIT KEX30 NEWKEYS CH_OPEN CH_CLOSE SR_AUTH"));
    expectedOutput.addBug(new OutputBug("Transport Layer Bug", "UNKNOWN", "KEXINIT/KEXINIT KEX30/KEX31+NEWKEYS NEWKEYS/NO_RESP UA_PK_OK/NO_RESP CH_OPEN/NO_RESP SR_AUTH/SR_ACCEPT", "KEXINIT KEX30 NEWKEYS UA_PK_OK CH_OPEN SR_AUTH"));
    expectedOutput.addBug(new OutputBug("Transport Layer Bug", "UNKNOWN", "KEXINIT/KEXINIT KEX30/KEX31+NEWKEYS NEWKEYS/NO_RESP UA_PK_NOK/NO_RESP CH_OPEN/NO_RESP SR_AUTH/SR_ACCEPT", "KEXINIT KEX30 NEWKEYS UA_PK_NOK CH_OPEN SR_AUTH"));
    expectedOutput.addBug(new OutputBug("Transport Layer Bug", "UNKNOWN", "KEXINIT/KEXINIT KEX30/KEX31+NEWKEYS KEX30/NO_RESP NEWKEYS/NO_RESP CH_OPEN/NO_RESP SR_AUTH/SR_ACCEPT", "KEXINIT KEX30 KEX30 NEWKEYS CH_OPEN SR_AUTH"));
    Output output_v7_23 = CommandsExec.runCommand(SSH_SERVER_MODEL_FOLDER + "BitVise-7.23_server.dot", SSH_SERVER_BUG_PATTERNS, true);
    assertCorrectOutput(expectedOutput, output_v7_23);
    Output output_v8_49 = CommandsExec.runCommand(SSH_SERVER_MODEL_FOLDER + "BitVise-8.49_server.dot", SSH_SERVER_BUG_PATTERNS, true);
