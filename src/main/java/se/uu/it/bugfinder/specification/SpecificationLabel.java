...
public class SpecificationLabel {
	private DescriptionToken description;
	private Update update;
	private Guard guard;
	
	public SpecificationLabel(DescriptionToken description) {
	...
	public SpecificationLabel(DescriptionToken description, Guard guard, Update update) {
		this.guard = guard;
		this.update = update;
		this.description = description;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SpecificationLabel other = (SpecificationLabel) obj;
		if (description == null) {
