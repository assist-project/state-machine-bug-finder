...
public class DfaDecoder {
	...
	public DfaAdapter decode(DFA<?, Label> encodedDfa, Collection<Label> labels, 
			Collection<Symbol> symbols) {
		FastDFA<Symbol> unfoldedSpec = unfold(encodedDfa, labels, symbols);
